...
const Navbar = () => {
  ...
  const getPageName = () => {
    switch (pathname) {
      case '/dashboard/cronograma': return 'Cronograma';
      case '/dashboard/comunicacao': return 'Comunicação';
      case '/dashboard/news': return 'Noticias';
      case '/dashboard/events': return 'Eventos';
      case '/dashboard/projects': return 'Progectos';
      case '/dashboard/feedback': return 'Feedback';
      case '/dashboard/helpcenter': return 'Central de Ajuda';
      case '/dashboard/vetrine': return 'Vitrine';
