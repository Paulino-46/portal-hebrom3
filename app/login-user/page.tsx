      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl bg-white/5 border border-white/10 p-8 backdrop-blur-md shadow-lg">
          <div className="mb-6 flex items-center gap-3">
            <div className="h-12 w-12 flex items-center justify-center rounded-lg bg-blue-500 text-white font-bold">U</div>
            <div>
              <h1 className="text-2xl font-semibold text-white">Entrar – Usuário</h1>
              <p className="text-sm text-slate-400">Acesse sua conta para acompanhar notícias e eventos.</p>
            </div>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-slate-500">Não tem conta? <a href="/signup" className="text-blue-400 hover:underline">Criar conta</a></div>
        </div>
      </div>
    </main>
  );
